...
/****************************** MACROS ******************************/
#define cuda_sha256_BLOCK_SIZE 32            // SHA256 outputs a 32 byte digest
...
typedef uint32_t  _WORD;             // 32-bit word, change to "long" for 16-bit machines
